...
enum parameters {ELEMENT_LENGTH,TAU,KAPPA,LAMBDA,NI,PSI,ALPHA,DELTA,ETA};
...
class mesh{
    ...
    public:
        void setParameters(float l,float tau,float kappa,float lambda,float ni,float psi,float alpha,float delta,float eta){
