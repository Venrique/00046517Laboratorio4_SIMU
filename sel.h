...
void createLocalB(Matrix &B,mesh m){
    ...
    B.at(0).at(0) += (-3*alpha)/2;     B.at(0).at(1) += (3*alpha)/2;
    B.at(1).at(0) += (-3*alpha)/2;     B.at(1).at(1) += (3*alpha)/2;
}
...
void createLocalF(Matrix &F,mesh m){
    ...
    F.at(0).at(0) += ni/l;  F.at(0).at(1) += -ni/l;
    F.at(1).at(0) += -ni/l;  F.at(1).at(1) += ni/l;
}

Matrix createLocalK(int element,mesh &m){
    Matrix K,A,B,C,D,E,F,G,H;
    ...
    row1.push_back(D.at(0).at(0)+F.at(0).at(0));                  
    row1.push_back(D.at(0).at(1)+F.at(0).at(1));

    row2.push_back(A.at(1).at(0)+C.at(1).at(0)); 
    row2.push_back(A.at(1).at(1)+C.at(1).at(1));
    row2.push_back(D.at(1).at(0)+F.at(1).at(0));                  
    row2.push_back(D.at(1).at(1)+F.at(1).at(1));
...
Vector createLocalb(int element,mesh &m){
    ...
    float psi = m.getParameter(PSI), eta = m.getParameter(ETA), l = m.getParameter(ELEMENT_LENGTH);
